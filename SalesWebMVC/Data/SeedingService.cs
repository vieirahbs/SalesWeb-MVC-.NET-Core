...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        //Método Seed deve ser chamado dentro da classe Startup
        public void Seed()
        {
            //Testa se já existe algum dado na base de dados:
            if (_context.Department.Any() || _context.Seller.Any() || _context.Sales.Any())
            {
                return;
            }

            #region Instanciação dos Departaments, Sellers e Sales Records:

            Department d1 = new Department(1, "Computers");
            Department d2 = new Department(2, "Eletronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");
                                                                    //Formato para inserir data
            ...
            #region Adiciona os objetos no banco de dados:
            _context.Department.AddRange(d1, d2, d3, d4);

            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            _context.Sales.AddRange(r1, r2, r3 , r4, r5, r6, r7, r8, r9, r10,
                r11, r12, r13, r14, r15, r16, r17, r18, r19, r20,
                r21, r22, r23, r24, r25, r26, r27, r28, r29, r30);

            //Salva e efetiva as alterações no banco de dados:
